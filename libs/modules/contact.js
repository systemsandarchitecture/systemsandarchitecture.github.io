      ...
      <div class="content">
        <div class="contact">
          <a href="tel:${variables.phoneLink}" class="contact-item">
            <i class="${variables.phoneIcon}" data-aos="zoom-in-up"></i>
            <p>${language('by phone', 'por teléfono')}</p>
            <p>${variables.phone}</p>
          </a>
          <a href="sms:${variables.phoneLink}" class="contact-item">
            <i class="${variables.smsIcon}" data-aos="zoom-in-up"></i>
          ...
          <a href="https://api.whatsapp.com/send?phone=${variables.whatsappLink}" target="_blank" class="contact-item">
            <i class="${variables.whatsappIcon}" data-aos="zoom-in-up"></i>
            <p>${language('by', 'por')} whatsapp</p>
            <p>${variables.phone}</p>
          </a>
          <a href="mailto:${variables.email}" class="contact-item">
            <i class="${variables.emailIcon}" data-aos="zoom-in-up"></i>
        ...
        <div id="contact-form">
          <form action="//formspree.io/${variables.email}" method="POST" class="contact-form">
            <div class="contact-form-header">
              <i class="${variables.contactFormIcon}"></i>
